...
describe 'ActiveRecord Obstacle Course' do
  ...
  it "13. groups an order's items by name" do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    grouped_items = Item.joins(:order_items).where(order_items: {order_id: 3}).group(:name)
    # ------------------------------------------------------------
  ...
  it '15. gets all item names associated with all orders' do
    ...
    names =            ["Thing 1", "Thing 1", "Thing 2", "Thing 3", "Thing 1", "Thing 1", "Thing 2", "Thing 3", "Thing 2", "Thing 3", "Thing 4", "Thing 5", "Thing 1", "Thing 1", "Thing 2", "Thing 3", "Thing 1", "Thing 4", "Thing 5", "Thing 7", "Thing 5", "Thing 8", "Thing 9", "Thing 10", "Thing 1", "Thing 5", "Thing 7", "Thing 9", "Thing 2", "Thing 3", "Thing 8", "Thing 9", "Thing 3", "Thing 4", "Thing 8", "Thing 10", "Thing 1", "Thing 4", "Thing 5", "Thing 7", "Thing 4", "Thing 5", "Thing 7", "Thing 9", "Thing 1", "Thing 3", "Thing 7", "Thing 10", "Thing 2", "Thing 3", "Thing 4", "Thing 7", "Thing 3", "Thing 5", "Thing 8", "Thing 9", "Thing 1", "Thing 4", "Thing 5", "Thing 7"]
  ...
  it '16. returns the names of users who ordered one specific item' do
    ...
    # ------------------ Using ActiveRecord ----------------------
    # Solution goes here
    users = User.distinct.left_outer_joins(:order_items).where(order_items: {item_id: item_8.id}).order(:name).pluck(:name)
    # ------------------------------------------------------------
  ...
  it '24. returns all orders for user 2 which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    #  Solution goes here
      orders = Order.joins(:order_items).where(order_items: {item_id: 4}, user_id: 2)
    # -----------------------------------------------------------
  ...
  it '25. returns items that are associated with one or more orders' do
    ...
    # Solution goes here
       ordered_items = Item.joins(:order_items).where("order_items.item_id = items.id").distinct
    # ---------------------------------------------------------------
  ...
  it '26. returns the names of items that are associated with one or more orders' do
    ...
    ordered_items_names = Item.joins(:order_items).where("order_items.item_id = items.id").distinct.map{|item| item.name}
    # ---------------------------------------------------------------
  ...
  it '28. returns a table of information for all users items' do
    ...
    # ------------------ ActiveRecord Solution ----------------------
    custom_results = User.joins(:order_items).select("users.name, count(order_items.item_id) as total_item_count").group(:name).order(name: :desc)
    # ---------------------------------------------------------------
